...
/**
 * Orion 1.x specific ApplicationServerHelper.
 *
 * @version $Id: CargoTask.java 391 2005-07-04 13:07:42Z vmassol $
 */
public class OrionApplicationServerHelper extends CargoApplicationServerHelper {
     ...
     */
    public OrionApplicationServerHelper(
     ...
     *                            directory
     * @return all jars in orion's home folder
     */
    protected File[] getDefaultLibraries(CargoContainerModel cargoContainerModel) {
        ...
        return homeDir.listFiles(new FileFilter() {
