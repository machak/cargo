 ...
 */
public class Orion1xIntegration extends AbstractCargoAppServerIntegration {
    /**
     * Constructor passing the Orion1x id.
     */
    public Orion1xIntegration() {
        super(Orion1xContainer.ID);
    }
    ...
    public static AbstractCargoAppServerIntegration getInstance() {
        return (AbstractCargoAppServerIntegration) (ApplicationManager.getApplication())
                .getComponent(Orion1xIntegration.class);
    }
