...
/**
 * Tomcat5x Integration.
 *
 * @version $Id: CargoTask.java 391 2005-07-04 13:07:42Z vmassol $
 */
public class Tomcat5xIntegration extends AbstractCargoAppServerIntegration {
    /**
     * Constructor passing the Tomcat5x id.
     */
    public Tomcat5xIntegration() {
        super(Tomcat5xContainer.ID);
    }
    ...
    public static AbstractCargoAppServerIntegration getInstance() {
        return (AbstractCargoAppServerIntegration) (ApplicationManager.getApplication())
                .getComponent(Tomcat5xIntegration.class);
    }
    ...
    protected ApplicationServerHelper createApplicationServerHelper() {
        return new Tomcat5xApplicationServerHelper(this);
    }
