 ...
 */
public class Tomcat4xApplicationServerHelper extends CargoApplicationServerHelper {
     ...
     */
    public Tomcat4xApplicationServerHelper(
    ...
    protected File[] getDefaultLibraries(CargoContainerModel cargoContainerModel) {
        ...
        return new File(homeDir, "common/lib").listFiles(new FileFilter() {
