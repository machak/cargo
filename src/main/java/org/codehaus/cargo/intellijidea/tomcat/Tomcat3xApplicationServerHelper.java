...
/**
 * Tomcat specific ApplicationServerHelper.
 *
 * @version $Id: CargoTask.java 391 2005-07-04 13:07:42Z vmassol $
 */
public class Tomcat3xApplicationServerHelper extends CargoApplicationServerHelper {
     ...
     */
    public Tomcat3xApplicationServerHelper(
     ...
     *                            directory
     * @return all jars and zips in Tomcat's common/lib folder
     */
    protected File[] getDefaultLibraries(CargoContainerModel cargoContainerModel) {
        ...
        return new File(homeDir, "lib/common").listFiles(new FileFilter() {
